...
typography:
 display-campaign: fontFamily: Nike Futura ND
 fontSize: 96px
 fontWeight: 500
 lineHeight: 0.9
 letterSpacing: 0
...
spacing:
 ...
 section: 48px
components:
 button-primary: backgroundColor: "{colors.ink}"
